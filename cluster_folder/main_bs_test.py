...
# Different seeds for testing sensibility to model initialization
for seed in [0, 1, 2, 3, 4]:
    # Test the different batch sizes
    for i, batch_size in enumerate([8, 16, 32, 64, 128, 256]):
            ...
            # To record the values to mlflow
            with mlflow.start_run(run_name="batch size = {}".format(batch_size)):
                ...
                # Log the metrics or post-training parameters
